...
- "breakeven"     : Move stop loss to entry price. e.g. "Move SL to breakeven", "move stop loss to break even", "BE", "B/E", "move to BE", "SL to BE", "breakeven now", "Go risk free", "Go risk-free", "Risk free", "risk free", "risk free now", "make it risk free". ONLY when the instruction is to MOVE the stop loss — NOT when it says to close.
